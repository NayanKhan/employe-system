<?php
    ...
    if(isset($_POST['btn'])){
        ...
        $message = $employee_info->save_employee_info($_POST);
    }
                ...
                <div class="well">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="number" class="form-control" name="employee_phone" placeholder="Enter Phone Number">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Employee Email:</label>
                            <div class="col-sm-10">
                            <input type="employee_email" class="form-control" name="employee_email" placeholder="Enter Email" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Employee Address:</label>
                            <div class="col-sm-10">
                            <textarea class="form-control" placeholder="Address" name="employee_address" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
